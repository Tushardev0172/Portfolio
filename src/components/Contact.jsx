...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-auto bg-gradient-to-t from-gray-700 to-zinc-900 text-white lg:pt-20 xs:py-12 font-default"
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          <form
            action="https://getform.io/f/agdyjygb"
            method="POST"
            className="flex flex-col w-full xs:w-3/4 sm:w-2/3 md:w-1/2"
          >
            <input
              type="text"
              name="name"
